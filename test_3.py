...
plt.imsave(f"Res_test/3_01_originale.png", subject.astype(np.uint8), cmap="gray")
plt.imsave(f"Res_test/3_02_masque.png", mask, cmap="gray")
plt.imsave(f"Res_test/3_03_resultat.png", res.astype(np.uint8), cmap="gray")
plt.show()
# %%
